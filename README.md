Visualization index
-------------------
This is a visual index of the visualizations included with the [Lightning](http://github.com/lightning-viz/lightning) server by default. Each visualization is an [`npm module`](https://www.npmjs.com/search?q=lightning-visualization). Images and thumbnails are also stored here for external use.
